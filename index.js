...
const unfundedString = `
  A total of $${totalRaised} has been raised for ${numGames} game${numGames > 1 ? 's' : ''}. 
...
// Create a new element for the top pledged game and append it to the correct element
const firstGameElement = document.createElement('p');
firstGameElement.textContent = firstGame.name;
firstGameContainer.appendChild(firstGameElement);

// Create a new element for the runner-up game and append it to the correct element
